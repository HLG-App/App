...
class SupabaseConfig {
  static const String supabaseUrl = 'https://tdlvomtuurscpjfnzcvj.supabase.co';
  static const String anonKey = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InRkbHZvbXR1dXJzY3BqZm56Y3ZqIiwicm9sZSI6ImFub24iLCJpYXQiOjE3Nzc4MDE2OTAsImV4cCI6MjA5MzM3NzY5MH0.V1ei48psQ6wBQERTW3DdVuLqHiGLKgpNuJp_yILssNM';
...
/// Minimal in-memory runtime state that should be cleared on sign out.
///
/// These are intentionally nullable and optional: if parts of the app don't use
/// them yet, clearing them is a harmless no-op.
